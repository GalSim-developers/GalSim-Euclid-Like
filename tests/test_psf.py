...
def test_get_psf_function():
    ...
    #psf_file_link = os.path.join(psf_dir, "monopsfs_6_5.fits.gz")
    #os.symlink(psf_file, psf_file_link)
    psfobjs = euclidlike.euclidlike_psf._make_psf_list("tests/psfs/monopsfs_6_6.fits.gz")
